...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    <title>PrePlaced || Quantitative Aptitude</title>
</head>
    ...
    <div class="bg-primary">
        ...
        <div class="row align-items-center">
            ...
            <div class="py-4 py-lg-6">
                <h1 class="mb-0 text-white display-4">Quantitative Aptitude</h1>
        ...
        <div class="py-6">
            ...
            <div class="row mb-6">
                ...
                <?php
                    ...
                    $sql="SELECT DISTINCT TOPICNAME FROM quantitative ORDER BY TOPICNAME ASC;";
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 col-12">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center p-3">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">
                                            <a href="questions.php?topicname=<?php echo $row["TOPICNAME"]; ?>&pagename=quantitative&page=1" class="text-inherit">
                ...
                <?php
                    ...
                    $sql="SELECT DISTINCT COMPANY FROM quantitative ORDER BY COMPANY ASC;";
                    $result = mysqli_query($conn,$sql);
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                while($row = mysqli_fetch_assoc($result))
                                {
                                    ...
                                    $sql_count="SELECT QUES_ID FROM quantitative WHERE COMPANY='".$row["COMPANY"]."';";
                                    $result_count_1 = mysqli_query($conn,$sql_count);
                                    $result_count_2 = mysqli_num_rows($result_count_1);
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6 col-12">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pt-1">
                                        <div class="d-flex">
                                        <a class="h2 py-3" href="questions.php?companyname=<?php echo $row["COMPANY"]; ?>&pagename=quantitative">
                                            <!-- Img -->
                                            <!-- <i class="fa fa-laptop"></i> -->
                                            <i class="fa fa-building px-3" aria-hidden="true"></i>
                                        <div class="ms-0">
                                            <h4 class="mb-0">
                                            <a href="questions.php?companyname=<?php echo $row["COMPANY"]; ?>&pagename=quantitative&page=1" class="text-inherit">
