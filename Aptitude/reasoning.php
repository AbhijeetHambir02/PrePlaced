...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    <title>PrePlaced || Reasoning</title>
</head>
    ...
    <div class="bg-primary">
        ...
        <div class="row align-items-center">
            ...
            <div class="py-4 py-lg-6">
                <h1 class="mb-0 text-white display-4">Reasoning</h1>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 col-12">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center p-3">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">
                                            <a href="questions.php?topicname=<?php echo $row["TOPICNAME"]; ?>&pagename=reasoning&page=1" class="text-inherit">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6 col-12">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pt-1">
                                        <div class="d-flex">
                                        <a class="h2 py-3" href="questions.php?companyname=<?php echo $row["COMPANY"]; ?>&pagename=reasoning">
                                            <!-- Img -->
                                            <i class="fa fa-building px-3" aria-hidden="true"></i>
                                            <!-- <img src="../assets/images/path/path-bootstrap.jpg" alt="" class="avatar-md" /></a> -->
                                        <div class="ms-0">
                                            <h4 class="mb-1">
                                            <a href="questions.php?companyname=<?php echo $row["COMPANY"]; ?>&pagename=reasoning&page=1" class="text-inherit">
