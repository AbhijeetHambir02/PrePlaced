	...
	e.fn.downCount = function (t, o) {
		...
		var r = this,
			...
			i = setInterval((function () {
				...
				r.find(".days").text(d), r.find(".hours").text(h), r.find(".minutes").text(c), r.find(".seconds").text(f), r.find(".days_ref").text(p), r.find(".hours_ref").text(u), r.find(".minutes_ref").text(g), r.find(".seconds_ref").text(m)
			}), 1e3)
	}
