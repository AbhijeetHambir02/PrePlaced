...
<?php
    if(isset($_GET['pagename']) && isset($_GET['topic']) && strlen($_GET['pagename'])>0 && strlen($_GET['topic'])>0 && isset($_GET['page']) && strlen($_GET['page'])>0)
    {
    ...
    {
        header("Location: department_topic.php");
        exit();
    }
?>
    ...
    <div class="container d-flex justify-content-center my-4">
        <?php
            ...
            echo '<ul class="pagination">';
                echo '<li class="page-item"> <a class="page-link" href="questions.php?pagename='.$tablename.'&topic='.$topicname.'&page='.$prev.'" tabindex="-1" aria-disabled="true">Previous</a> </li>';
                for($i=1; $i<= $total_pages; $i++)
                {
                    echo '<li class="page-item"><a class="page-link" href="questions.php?pagename='.$tablename.'&topic='.$topicname.'&page='.$i.'">'.$i.'</a></li>';
                }
                echo '<li class="page-item"> <a class="page-link" href="questions.php?pagename='.$tablename.'&topic='.$topicname.'&page='.$next.'">Next</a> </li>';
            echo '</ul>';
        ?>
    </div>
