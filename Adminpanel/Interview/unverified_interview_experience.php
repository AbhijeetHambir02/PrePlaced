    ...
    <div class="container-fluid p-6">
            ...
            <div class="col-lg-12 col-md-12 col-12">
                <div class="border-bottom pb-2 mb-6 d-md-flex justify-content-between align-items-center">
                    <div class="mb-3 mb-md-0">
                        <h1 class="mb-0 h2 fw-bold"> Verify Interview Experience</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <div class="card-body">
                    <div class="my-60">
                        ...
                        <p class="text-inherit" style="font-size:1.2rem;">
                            ...
                            ?>
                            <div class="fs-4"><?php echo $show_interview; ?></div>
                        </p>
                    </div>
                    <div>
                    ...
                    <div class="mt-4 text-center mb-4">
                        <form action="verify_interview_experiencedb.php" method="POST">
                            <input type="hidden" name="id" value="<?php echo $int_id; ?>">
            ...
            <?php
                ...
                ?>
                <h4 class="mb-2 text-end"><a href="unverified_interview_experiences.php"><button type="button" class="btn btn-primary mt-4 p-2 px-4 mx-4">Back</button></a></h4>
        </div>
    </div>          
