...
<body>
    ...
    <div class="container-fluid p-4">
        ...
        <?php
            $query = "SELECT * FROM users WHERE signup_verification='Verified' ORDER BY user_name ASC";
                ...
                <div class="card">
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tr class="table-primary">
                            ...
                            <th class="py-3" style="font-size:1rem;">Photo</th>
                            <th class="py-3" style="font-size:1rem;">ID</th>
                            <th class="py-3" style="font-size:1rem;">Name</th>
                            <th class="py-3" style="font-size:1rem;">Email</th>
                            <th class="py-3" style="font-size:1rem;">Birth Date</th>
                            <th class="py-3" style="font-size:1rem;">Login Type</th>
                        </tr>
                        </thead>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="avatar avatar-md">
                                    <img alt="avatar" src="<?php echo substr($data['profile_pic_path'],0);?>" class="rounded-circle" />
                                </div>
                            </td>
                            <td>
                                <span class="h4 text-inherit"> <?php echo strtoupper($data['user_id']); ?> </span>
                            </td>
                            <td>
                            <a href="user.php?var=<?php echo $data['user_email'];?>"><span class="h4 text-inherit"> <?php echo ucwords(strtolower($data['user_name'])); ?> </span></a>
                            </td>
                            <td>
                                <a href="user.php?var=<?php echo $data['user_email'];?>"><span class="h4 text-inherit"> <?php echo strtolower($data['user_email']); ?> </span></a>
                            </td>
                            <td>
                                <span class="h4 text-inherit"> <?php if($data['user_birthdate'] != null){ echo ucfirst($data['user_birthdate']); } else{ ?> <span class="text-muted fw-lighter">No data</span> <?php } ?> </span>
                            </td>
                            <?php
            ...
            <div class="container d-flex justify-content-center my-4">
                <?php
                    ...
                    echo '<ul class="pagination mt-4">';
                        echo '<li class="page-item"> <a class="page-link" href="users.php?page='.$prev.'" tabindex="-1" aria-disabled="true">Previous</a> </li>';
                        for($i=1; $i<= $total_pages; $i++)
                        {
                            echo '<li class="page-item"><a class="page-link" href="users.php?page='.$i.'">'.$i.'</a></li>';
                        }
                        echo '<li class="page-item"> <a class="page-link" href="users.php?page='.$next.'">Next</a> </li>';
                    echo '</ul>';
                ?>
            </div>
