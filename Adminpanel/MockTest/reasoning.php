...
<link rel="stylesheet" href="../../assets/css/theme.min.css">
    <title>PrePlaced || Mock Tests Reasoning</title>
...
<body>
    ...
    <div class="container-fluid p-4">
            ...
            <div class="col-lg-12 col-md-12 col-12">
                <div class="border-bottom pb-2 mb-6 d-md-flex justify-content-between align-items-center">
                    <div class="mb-3 mb-md-0">
                        <h1 class="mb-0 h2 fw-bold">Mock tests of Reasoning</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <?php
            $query = "SELECT * FROM test_result WHERE QTYPE='reasoning' ORDER BY CORRECT_ANS DESC";
            ...
            <div class="container d-flex justify-content-center my-4">
                <?php
                    ...
                    echo '<ul class="pagination mt-4">';
                        echo '<li class="page-item"> <a class="page-link" href="reasoning.php?page='.$prev.'" tabindex="-1" aria-disabled="true">Previous</a> </li>';
                        for($i=1; $i<= $total_pages; $i++)
                        {
                            echo '<li class="page-item"><a class="page-link" href="reasoning.php?page='.$i.'">'.$i.'</a></li>';
                        }
                        echo '<li class="page-item"> <a class="page-link" href="reasoning.php?page='.$next.'">Next</a> </li>';
                    echo '</ul>';
                ?>
            </div>
