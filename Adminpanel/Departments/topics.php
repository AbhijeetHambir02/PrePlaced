            ...
            <div class="col-lg-12 col-md-12 col-12">
                <div class="border-bottom pb-2 mb-6 d-md-flex justify-content-between align-items-center">
                    <div class="mb-3 mb-md-0">
                        <h1 class="mb-0 h2 fw-bold"><?php echo ucfirst($pagename); ?></h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <?php
                ...
                {   
                    ...
                    $sql_count="SELECT QUES_ID FROM $pagename WHERE TOPICNAME='".$data["TOPICNAME"]."';";
                    $result_count_1 = mysqli_query($conn,$sql_count);
                    $ques_count = mysqli_num_rows($result_count_1);
                    $count+=1;
            ?>
            ...
            <div class="card mb-4 card-hover">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="">
                            <h3 class="mb-0"><a href="questions.php?pagename=<?php echo $pagename; ?>&topicname=<?php echo $data['TOPICNAME']; ?>&page=1" class="text-inherit"><?php echo $count.". ".$data['TOPICNAME']; ?></a></h3>
                        </div>
                    </div>
                    <div class="mt-2">
                    <a class="text-muted texttooltip" data-template="phone">
                        <div>
                            <span><?php echo $ques_count; ?> Questions</span>
                        </div>
                    </a>
                    </div>
                </div>
