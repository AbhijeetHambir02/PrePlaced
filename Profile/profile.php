	...
	<div class="row mt-0 mt-md-4">
				...
				<div class="col-lg-9 col-md-8 col-12">
					...
					if(isset($_GET['result'])){
						...
						elseif($_GET['result']=="uploadsuccess"){
							echo '<div class="alert alert-success d-flex align-items-center" role="alert">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-check-circle-fill me-2" viewBox="0 0 16 16">
									<path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
								</svg>
						...
						elseif($_GET['result']=="avatardeleted"){
							echo '<div class="alert alert-success d-flex align-items-center" role="alert">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-check-circle-fill me-2" viewBox="0 0 16 16">
									<path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
								</svg>
						...
						elseif($_GET['result']=="invalidfile"){
							echo '<div class="alert alert-warning d-flex align-items-center" role="alert">
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-exclamation-triangle-fill me-2" viewBox="0 0 16 16">
									<path d="M8.982 1.566a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767L8.982 1.566zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
									</svg>
						...
						<div class="card-body">
							<div class="d-lg-flex align-items-center justify-content-between">
								<div class="d-flex align-items-center mb-4 mb-lg-0">
									<img src="<?php echo substr($row['profile_pic_path'],3);?>" id="img-uploaded" class="avatar-xl rounded-circle" alt="" />
									<div class="ms-3">
								...
								<div>
									<a href="#" class="btn btn-outline-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal-2">Update</a>
									<a href="editprofile/delete_avatar.php" class="btn btn-outline-danger btn-sm">Delete</a>
								</div>
							</div>
							<hr class="my-5" />
							<div>
								...
								<!-- Form -->
								<form class="row" action="editprofile/edit_profile_db.php" method="POST">
									<!-- First name -->
									<div class="mb-3 col-12 col-md-6">
										<label class="form-label" for="fname">Name</label>
										<input type="text" id="fname" class="form-control" name="user_name" value="<?php echo $row['user_name']; ?>" placeholder="Name" required />
									</div>
									
									<!-- Phone -->
									<div class="mb-3 col-12 col-md-6">
										<label class="form-label" for="phone">Email</label>
										<input type="email" id="phone" class="form-control" value="<?php echo $row['user_email']; ?>" placeholder="Email" disabled/>
									</div>
									<!-- Birthday -->
									<div class="mb-3 col-12 col-md-6">
										...
										<input class="form-control flatpickr" type="text" placeholder="Birth of Date" id="birth"
											name="user_birthdate" value="<?php echo $row['user_birthdate']; ?>" required/>
									</div>
									<!-- Joining Date -->
									<div class="mb-3 col-12 col-md-6">
										<label class="form-label" for="phone">Date Joined</label>
										<input type="text" id="phone" class="form-control" value="<?php echo $row['signup_date']; ?>" placeholder="Email" disabled/>
									</div>
									<div class="col-12">
										<!-- Button -->
										<button class="btn btn-primary" name="editprofile_sbtn" type="submit">
											Update Profile
										</button>
									</div>
